interface LinkedInSimpleLogoProps {
  width?: number;
  height?: number;
}

export default function LinkedInSimpleLogo({ width = 34, height = 34 }: LinkedInSimpleLogoProps) {
  return (
    <svg
      ...
      viewBox="0 0 34 34"
      className="c638f934 f7336c2f _554d7eb5 _550bc6c7"
      role="img"
    >
      <path
        fill="#0a66c2"
